...
public class UserController {
	...
	@RequestMapping(value = "/usersByFeign/{username}", method = RequestMethod.GET)
	public ResponseEntity<List<User>> readUserInfoByFeign(@PathVariable("username") String userName) {
		List<User> users = client.users(userName);
		return new ResponseEntity<List<User>>(users, HttpStatus.OK);
	}
